...
- `/house_chats_now` — прочитать новые сообщения из домовых Telegram-чатов и отправить сводку по каждому дому.
...
# Жёсткий верхний предел в коде: не более 300 сообщений/постов за запуск на один источник
...
# Домовые чаты: пары "Название дома=чат" через ;
# Пример: Дом на Ленина=@house_chat_1;ЖК Северный=-1001234567890
TELEGRAM_HOUSE_CHATS=Дом 1=@house_chat_1;Дом 2=@house_chat_2
```
