...
Меню команд (кнопка «Меню» в Telegram) регистрируется ботом при старте и видно только в owner chat.
...
- `/stats_csv` — выгрузить ежедневную статистику писем (история с момента включения) CSV-файлом в чат.
